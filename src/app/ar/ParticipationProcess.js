...
const steps = [
  {
    ...
    percent: 5,
    desc: 'الخطوة الأولى لجميع الجهات المهتمة — سواء الشركات الكبرى أو المشاريع المشتركة أو الخبراء المستقلون أو حتى الشركات الناشئة — هي تسجيل الاهتمام رسميًا عبر منصة صندوق التنمية وإعادة إعمار ليبيا. تضمن هذه الخطوة دخولك ضمن قائمة المتنافسين.',
    deadline: 'الخميس، 26 مارس 2026 — آخر موعد للتسجيل المبدئي',
  },
  {
    id: 2,
    label: 'الاعتماد وتقديم المقترحات',
    percent: 60,
    desc: 'بعد التسجيل، تخضع جميع الطلبات لمراجعة أولية. وسيتم التواصل رسميًا مع المرشحين الذين يستوفون متطلبات الخبرة والمعايير المهنية لاعتماد مشاركتهم. بعدها يحصل المشاركون المعتمدون على ملف المدينة الشامل والإرشادات الرسمية لتقديم المخطط المفاهيمي التفصيلي والحلول الحضرية.',
    deadline: 'الأحد، 26 أبريل 2026 — آخر موعد لتسليم المقترحات',
  },
  {
    id: 3,
    label: 'التقييم والاختيار',
    percent: 100,
    desc: 'بعد موعد التسليم، تُقيَّم جميع المقترحات بدقة من قبل لجنة فنية متعددة التخصصات. تركز المعايير على الإبداع والمسؤولية الثقافية والكفاءة الحضرية والجدوى الاقتصادية. وتتقدم أفضل المقترحات إلى فعالية بنغازي على مدى ثلاثة أيام للمراجعة النهائية والعروض والمشاركة في المؤتمرات والمعارض. كما تتلقى المقترحات الفردية الاستثنائية دعمًا لضمان حضورها على المستوى الدولي.',
    deadline: null,
  },
];
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <img src="/images/uob.jpg" alt="خلفية بنغازي" playsInline className="w-full h-full object-cover"/> 
