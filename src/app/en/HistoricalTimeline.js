...
export default function HistoricalTimeline() {
  ...
  const events = useMemo(
    () => [
      {
        year: '1911',
        title: 'Italian Colonial Plan',
        description: 'The Italian authorities initiated the first comprehensive urban plan, establishing Benghazi’s initial administrative and commercial nucleus.'
      },
      {
        year: '1966',
        title: 'Doxiadis Associates Plan',
        description: 'A comprehensive urban development plan was introduced, focusing on real estate investment and central services expansion.'
      },
      {
        year: '1984',
        title: 'Costa’s Modern City Center Design',
        description: 'Renowned architect Costa proposed a modern city center design, aiming to redefine Benghazi’s urban core.'
      },
      {
        year: '1984',
        title: 'Kisho Kurokawa’s Corniche Project',
        description: 'The Japanese office of Kisho Kurokawa developed an urban design project for the Corniche, enhancing coastal accessibility.'
      },
      {
        year: '1992',
        title: 'Utilities Consulting Office Project',
        description: 'An urban center project was proposed to revitalize the city’s core, though it remained largely unimplemented.'
      },
      {
        year: '2009',
        title: 'Third-Generation Plan by Al-Emara Al-Emara',
        description: 'Consulting Engineers introduced a forward-thinking plan to guide Benghazi’s development through 2025.'
      },
      {
        year: '2026',
        title: 'Sustainable Future Vision Plan',
        description: 'A new master plan focuses on sustainability, smart technologies, and green urban spaces, aiming to position Benghazi as a regional leader in modern, environmentally responsible urban development.'
      },
