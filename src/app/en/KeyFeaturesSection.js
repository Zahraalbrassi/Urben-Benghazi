...
const FEATURES = [
    {
        ...
        description:
            'Building strong global alliances to foster innovation, growth, and economic diplomacy.',
        Icon: Globe,
    },
    {
        title: 'Strategic Economic Transformation',
        description:
            'Advancing urban progress through sustainable development and responsible resource management.',
        Icon: ChartColumnBig,
    },
    {
        title: 'Sustainable and Responsible Development',
        description:
            'Advancing urban progress through sustainable development and resource management.',
        Icon: Recycle,
    },

    {
        title: 'Smart and Innovative Urban Solutions',
        description:
            'Harnessing creativity and advanced technology to build cities ready for the future.',
        Icon: Brain,
    },
    {
        title: 'Cultural Vitality and Community Empowerment',
        description:
            'Enriching urban life by celebrating the city’s unique cultural identity and empowering its people.',
        Icon: Handshake,
    },
   {
        title: 'Infrastructure and Legacy Vision',
        description:
            'Upgrading systems through bold, future-oriented strategies that ensure lasting achievement.',
        Icon: Building2,
    },
];
