...
const participationPaths = [
  {
    ...
    description: 'Join the competition to become a key participant in the initiative.',
    image: '/images/compatitive.png',
  },
  {
    id: 'strategic',
    title: 'Strategic Visitor',
    description: 'Partner with the initiative for long-term collaboration and investment.',
      ...
      <div className="relative z-10 max-w-6xl mx-auto text-center">
        ...
        <div className="mb-20 space-y-4">
          ...
          <p className={`max-w-2xl mx-auto text-lg md:text-xl font-medium ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            Discover how experts, investors, and government partners can join the Benghazi Urban Initiative.
          </p>
        </div>
